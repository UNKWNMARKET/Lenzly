...
function mergedRaws(state: string): Raw[] {
  const groups = [RAW_BY_STATE[state], RAW_EXTRA[state], RAW_EXTRA2[state]]
...
const RAW_EXTRA: Record<string, Raw[]> = {
  ...
  NJ: [
    ['Cape May Victorian', 'Cape May', 'Architecture', 38.9350, -74.9250, 'Streets of brightly painted gingerbread Victorians.'],
    ['Liberty State Park Skyline', 'Jersey City', 'Skyline', 40.7050, -74.0550, 'The Statue of Liberty and Manhattan across the water.'],
    ['Great Falls Paterson Detail', 'Paterson', 'Waterfall', 40.9160, -74.1810, 'A 77-foot waterfall in the first US industrial city.'],
    ['Sandy Hook Light', 'Highlands', 'Lighthouse', 40.4640, -74.0010, 'The oldest working lighthouse in the country.'],
    ['Asbury Park Boardwalk', 'Asbury Park', 'Beach', 40.2200, -74.0000, 'A revived boardwalk of vintage architecture.'],
    ['Delaware Water Gap Mt Tammany', 'Hardwick', 'Mountains', 41.0000, -75.1300, 'A cliff overlook of the river gap.'],
    ['Cape May Sunset Beach', 'Cape May', 'Beach', 38.9300, -74.9700, 'A pebble beach famous for "Cape May diamonds".'],
    ['Ocean Grove Tents', 'Ocean Grove', 'Historic', 40.2120, -74.0070, 'A Victorian tent city around a grand auditorium.'],
    ['Buttermilk Falls NJ', 'Layton', 'Waterfall', 41.1900, -74.8700, 'The tallest waterfall in New Jersey in tiers.'],
    ['High Point Monument', 'Sussex', 'Mountains', 41.3210, -74.6610, 'A 220-foot obelisk on the state’s highest point.'],
    ['Grounds for Sculpture Path', 'Hamilton', 'Street Art', 40.2300, -74.6900, 'Monumental sculptures in a landscaped park.'],
    ['Barnegat Light', 'Barnegat Light', 'Lighthouse', 39.7640, -74.1080, '"Old Barney" red-and-white tower on Long Beach Island.'],
    ['Wildwood Boardwalk', 'Wildwood', 'Beach', 38.9900, -74.8200, 'Neon piers and the widest free beach in NJ.'],
    ['Palisades Cliffs', 'Fort Lee', 'Mountains', 40.8500, -73.9500, 'Sheer cliffs above the Hudson facing Manhattan.'],
    ['Princeton University', 'Princeton', 'Architecture', 40.3490, -74.6590, 'Collegiate Gothic halls and Blair Arch.'],
  ],
  NM: [
    ['White Sands Sunset', 'Alamogordo', 'Desert', 32.7790, -106.1710, 'Pink-gold light rippling across white gypsum dunes.'],
    ['Bisti Hoodoos', 'Farmington', 'Desert', 36.2600, -108.0000, 'Otherworldly rock formations in a remote badland.'],
    ['Santa Fe Loretto Chapel', 'Santa Fe', 'Architecture', 35.6850, -105.9370, 'A Gothic chapel with a mysterious spiral staircase.'],
    ['Tent Rocks Slot', 'Cochiti', 'Canyon', 35.6600, -106.4100, 'A narrow slot trail beneath cone-shaped hoodoos.'],
    ['Taos Pueblo Adobe', 'Taos', 'Architecture', 36.4390, -105.5450, 'Multistoried adobe dwellings against Taos Mountain.'],
    ['Carlsbad Big Room', 'Carlsbad', 'Nature', 32.1480, -104.5570, 'A vast underground chamber of dripstone.'],
    ['Rio Grande Gorge Sunset', 'Taos', 'Bridge', 36.4640, -105.7290, 'The high bridge over the West’s great chasm at dusk.'],
    ['Sandia Tram', 'Albuquerque', 'Mountains', 35.2080, -106.4490, 'A tram to a watermelon-pink ridge at sunset.'],
    ['Chaco Canyon', 'Nageezi', 'Historic', 36.0600, -107.9600, 'Monumental ancestral Puebloan great houses.'],
    ['City of Rocks NM', 'Faywood', 'Desert', 32.5900, -107.9700, 'Volcanic boulders forming desert "streets".'],
    ['Valles Caldera Elk', 'Jemez Springs', 'Nature', 35.8900, -106.5300, 'A grassy supervolcano caldera with elk herds.'],
    ['Albuquerque Balloon Fiesta', 'Albuquerque', 'Skyline', 35.2000, -106.6000, 'Hundreds of hot-air balloons at dawn.'],
    ['Kasha-Katuwe', 'Cochiti', 'Canyon', 35.6600, -106.4100, 'Tent-shaped rocks and a canyon slot.'],
    ['Shiprock Pinnacle', 'Shiprock', 'Desert', 36.6870, -108.8360, 'A 1,500-foot volcanic monolith on the high desert.'],
    ['Gila Cliff Dwellings', 'Silver City', 'Historic', 33.2270, -108.2720, 'Ancient cliff homes in a forested canyon.'],
  ],
  NY: [
    ['Niagara Horseshoe Night', 'Niagara Falls', 'Waterfall', 43.0780, -79.0750, 'The illuminated falls in color after dark.'],
    ['Manhattan DUMBO View', 'New York', 'Skyline', 40.7030, -73.9890, 'The Manhattan Bridge framed between brick streets.'],
    ['Central Park Bethesda', 'New York', 'Park', 40.7740, -73.9710, 'The grand terrace and angel fountain by the lake.'],
    ['Letchworth Middle Falls', 'Castile', 'Waterfall', 42.5870, -78.0510, 'A 107-foot waterfall in the "Grand Canyon of the East".'],
    ['Watkins Glen Gorge', 'Watkins Glen', 'Waterfall', 42.3760, -76.8720, 'A trail beneath waterfalls and stone bridges.'],
    ['Statue of Liberty', 'New York', 'Landmark', 40.6892, -74.0445, 'The colossal copper statue in the harbor.'],
    ['Empire State View', 'New York', 'Skyline', 40.7484, -73.9857, 'The Art Deco spire towering over Midtown.'],
    ['Lake Placid Mirror', 'Lake Placid', 'Lake', 44.2790, -73.9790, 'High Peaks reflected in a still lake.'],
    ['Taughannock Falls', 'Trumansburg', 'Waterfall', 42.5450, -76.6080, 'A 215-foot plunge, taller than Niagara.'],
    ['Bear Mountain Bridge', 'Fort Montgomery', 'Bridge', 41.3200, -73.9870, 'A 1924 span over the Hudson amid autumn ridges.'],
    ['Brooklyn Bridge Walk', 'New York', 'Bridge', 40.7061, -73.9969, 'The Gothic-arched promenade over the East River.'],
    ['Adirondack Whiteface', 'Wilmington', 'Mountains', 44.3660, -73.9030, 'A summit road and gondola to High Peaks views.'],
    ['Buttermilk Falls Ithaca', 'Ithaca', 'Waterfall', 42.4160, -76.5210, 'A cascading staircase of waterfalls.'],
    ['Thousand Islands', 'Alexandria Bay', 'Lake', 44.3380, -75.9180, 'Boldt Castle on an island in the St. Lawrence.'],
    ['Cooperstown Otsego', 'Cooperstown', 'Lake', 42.7000, -74.9200, '"Glimmerglass" lake ringed by hills.'],
  ],
  NC: [
    ['Blue Ridge Linn Cove', 'Linville', 'Bridge', 36.0950, -81.8090, 'A curving viaduct hugging Grandfather Mountain.'],
    ['Cape Hatteras Spiral', 'Buxton', 'Lighthouse', 35.2510, -75.5290, 'The tallest brick lighthouse in America, black-spiraled.'],
    ['Biltmore Facade', 'Asheville', 'Architecture', 35.5400, -82.5510, 'America’s largest home, a French Renaissance château.'],
    ['Dry Falls', 'Highlands', 'Waterfall', 35.0700, -83.2400, 'A waterfall you can walk behind without getting wet.'],
    ['Looking Glass Falls', 'Pisgah Forest', 'Waterfall', 35.2980, -82.7690, 'A 60-foot roadside waterfall in Pisgah.'],
    ['Mount Mitchell', 'Burnsville', 'Mountains', 35.7650, -82.2650, 'The highest peak east of the Mississippi.'],
    ['Outer Banks Bodie Light', 'Nags Head', 'Lighthouse', 35.8180, -75.5630, 'A black-and-white banded coastal lighthouse.'],
    ['Chimney Rock Flag', 'Chimney Rock', 'Mountains', 35.4320, -82.2440, 'A granite spire above Hickory Nut Gorge.'],
    ['Whitewater Falls Upper', 'Sapphire', 'Waterfall', 35.0290, -83.0150, 'The highest waterfall east of the Rockies.'],
    ['Asheville Skyline', 'Asheville', 'Skyline', 35.5950, -82.5510, 'Art Deco downtown ringed by blue mountains.'],
    ['Cape Lookout Diamond', 'Harkers Island', 'Lighthouse', 34.6230, -76.5240, 'A diamond-patterned lighthouse on a wild island.'],
    ['Grandfather Swinging Bridge', 'Linville', 'Bridge', 36.0950, -81.8310, 'A mile-high suspension footbridge.'],
    ['Linville Gorge', 'Linville Falls', 'Canyon', 35.9100, -81.9000, 'The deepest gorge in the eastern US.'],
    ['Cullasaja Falls', 'Highlands', 'Waterfall', 35.1100, -83.2700, 'A 250-foot roadside cascade in a gorge.'],
    ['Jockey’s Ridge', 'Nags Head', 'Beach', 35.9650, -75.6300, 'The tallest natural sand dune on the East Coast.'],
  ],
  ND: [
    ['TR Painted Canyon', 'Medora', 'Canyon', 46.8900, -103.3800, 'A sweeping badlands overlook off the interstate.'],
    ['TR Wind Canyon', 'Medora', 'Canyon', 46.9300, -103.5300, 'A wind-sculpted bend of the Little Missouri at sunset.'],
    ['Enchanted Highway Geese', 'Regent', 'Street Art', 46.4200, -102.5500, 'Giant scrap-metal sculptures along a prairie road.'],
    ['Bismarck Capitol Tower', 'Bismarck', 'Architecture', 46.8200, -100.7800, 'A 19-story Art Deco "skyscraper on the prairie".'],
    ['Lake Sakakawea Sunset', 'Pick City', 'Lake', 47.5000, -101.4000, 'Big-sky sunsets over a vast reservoir.'],
    ['Pembina Gorge', 'Walhalla', 'Canyon', 48.9200, -97.8600, 'The deepest, most forested valley in the state.'],
    ['Sully Creek', 'Medora', 'Nature', 46.8700, -103.5200, 'Riverside badlands and cottonwood camps.'],
    ['White Butte Summit', 'Amidon', 'Nature', 46.3850, -103.3000, 'The highest point in North Dakota rising from badlands.'],
    ['Fort Mandan Stockade', 'Washburn', 'Historic', 47.2900, -101.0900, 'A reconstruction of Lewis & Clark’s winter fort.'],
    ['Peace Garden Towers', 'Dunseith', 'Park', 48.9990, -100.0590, 'Formal gardens straddling the US–Canada border.'],
    ['TR Oxbow Overlook', 'Watford City', 'Canyon', 47.5900, -103.3000, 'A horseshoe bend of the Little Missouri in the north unit.'],
    ['Maah Daah Hey', 'Medora', 'Nature', 46.9000, -103.4500, 'A famous trail winding through badlands buttes.'],
    ['Knife River Villages', 'Stanton', 'Historic', 47.3300, -101.3800, 'Earthlodge depressions of historic Hidatsa villages.'],
    ['Lake Metigoshe', 'Bottineau', 'Lake', 48.9800, -100.3300, 'A wooded lake in the Turtle Mountains.'],
    ['Sheyenne Valley', 'Fort Ransom', 'Nature', 46.5200, -97.9300, 'Rolling green river hills and a historic village.'],
  ],
  OH: [
    ['Hocking Old Mans Cave', 'Logan', 'Canyon', 39.4280, -82.5410, 'A gorge of recessed caves, bridges, and waterfalls.'],
    ['Cuyahoga Brandywine', 'Peninsula', 'Waterfall', 41.2770, -81.5400, 'A 65-foot waterfall in Ohio’s national park.'],
    ['Cleveland West Side Market', 'Cleveland', 'Architecture', 41.4840, -81.7020, 'A 1912 market hall with a soaring clock tower.'],
    ['Hocking Ash Cave', 'South Bloomingville', 'Canyon', 39.3970, -82.5460, 'A vast horseshoe recess cave with a thin waterfall.'],
    ['Marblehead Light Lake Erie', 'Marblehead', 'Lighthouse', 41.5360, -82.7120, 'The oldest working Great Lakes lighthouse.'],
    ['Cincinnati Roebling Bridge', 'Cincinnati', 'Bridge', 39.0930, -84.5100, 'A historic suspension bridge over the Ohio River.'],
    ['Hocking Cedar Falls', 'South Bloomingville', 'Waterfall', 39.4200, -82.5300, 'A powerful waterfall in a hemlock gorge.'],
    ['Cleveland Skyline Edgewater', 'Cleveland', 'Skyline', 41.4900, -81.7400, 'The downtown skyline from a Lake Erie beach.'],
    ['Serpent Mound', 'Peebles', 'Historic', 39.0250, -83.4300, 'A 1,348-foot prehistoric effigy mound.'],
    ['Conkles Hollow Rim', 'Rockbridge', 'Canyon', 39.4500, -82.5700, 'A cliff-rim trail above a deep gorge.'],
    ['Columbus Scioto Mile', 'Columbus', 'Skyline', 39.9610, -83.0000, 'Fountains and bridges below the downtown towers.'],
    ['Lake Erie Kelleys Island', 'Kelleys Island', 'Lake', 41.6000, -82.7100, 'Glacial grooves carved in limestone bedrock.'],
    ['Charleston Falls', 'Tipp City', 'Waterfall', 39.9700, -84.1500, 'A 37-foot "Little Niagara" in a preserve.'],
    ['Cuyahoga Ledges', 'Peninsula', 'Nature', 41.2200, -81.5100, 'Mossy sandstone ledges and an overlook.'],
    ['Mohican Gorge', 'Loudonville', 'Canyon', 40.6100, -82.2700, 'A clear-water river gorge with covered bridge and falls.'],
  ],
  OK: [
    ['Wichita Mountains Bison', 'Lawton', 'Mountains', 34.7280, -98.7100, 'Ancient granite peaks and free-roaming bison.'],
    ['Turner Falls Pool', 'Davis', 'Waterfall', 34.4250, -97.1470, 'A 77-foot waterfall into a natural swimming pool.'],
    ['Gloss Mountains Mesa', 'Fairview', 'Mountains', 36.3400, -98.5600, 'Selenite-flecked mesas glittering in the sun.'],
    ['Great Salt Plains Crystals', 'Jet', 'Desert', 36.7500, -98.2000, 'A white flat where you dig hourglass selenite crystals.'],
    ['Beavers Bend River', 'Broken Bow', 'Nature', 34.1390, -94.6810, 'Pine forests and a clear river in the Ouachitas.'],
    ['Tulsa Golden Driller', 'Tulsa', 'Landmark', 36.1340, -95.9300, 'A 75-foot statue and Art Deco skyline.'],
    ['Black Mesa Summit', 'Kenton', 'Nature', 36.9300, -102.9700, 'Oklahoma’s highest point in a remote panhandle.'],
    ['Robbers Cave Bluffs', 'Wilburton', 'Nature', 34.9900, -95.3300, 'Sandstone bluffs and an outlaw cave.'],
    ['OKC Memorial Reflecting', 'Oklahoma City', 'Landmark', 35.4730, -97.5070, 'The Field of Empty Chairs at dusk.'],
    ['Natural Falls Grotto', 'West Siloam Springs', 'Waterfall', 36.1700, -94.6700, 'A 77-foot waterfall in a green grotto.'],
    ['Roman Nose Springs', 'Watonga', 'Canyon', 35.9200, -98.4400, 'Spring-fed canyons in red-rock gypsum hills.'],
    ['Alabaster Caverns', 'Freedom', 'Nature', 36.7000, -99.1500, 'The largest gypsum cave in the world open to the public.'],
    ['Tallgrass Prairie Preserve OK', 'Pawhuska', 'Nature', 36.8400, -96.4100, 'The largest protected tallgrass prairie with bison.'],
    ['Mount Scott', 'Lawton', 'Mountains', 34.7400, -98.5300, 'A summit road to wide views of the Wichita range.'],
    ['Little Sahara', 'Waynoka', 'Desert', 36.5400, -98.9400, 'Towering red sand dunes on the plains.'],
  ],
  OR: [
    ['Crater Lake Rim', 'Crater Lake', 'Lake', 42.9446, -122.1090, 'The deepest, bluest lake in the US from the rim drive.'],
    ['Cannon Beach Sunset', 'Cannon Beach', 'Beach', 45.8847, -123.9680, 'Haystack Rock silhouetted against a Pacific sunset.'],
    ['Multnomah Footbridge', 'Bridal Veil', 'Waterfall', 45.5762, -122.1158, 'The arched bridge between the two tiers of Oregon’s tallest falls.'],
    ['Painted Hills Sunset', 'Mitchell', 'Desert', 44.6610, -120.2740, 'Banded red-and-gold hills glowing at golden hour.'],
    ['Trillium Lake Mt Hood', 'Government Camp', 'Mountains', 45.2440, -121.7270, 'Mount Hood mirrored in a calm lake.'],
    ['Smith Rock Bend', 'Terrebonne', 'Mountains', 44.3680, -121.1390, 'Volcanic cliffs above a curving river.'],
    ['Oregon Dunes', 'Florence', 'Desert', 43.8800, -124.1300, 'Coastal sand dunes towering up to 500 feet.'],
    ['Wahclella Falls', 'Cascade Locks', 'Waterfall', 45.6300, -121.9500, 'A powerful waterfall in a mossy basalt amphitheater.'],
    ['Heceta Head Light', 'Florence', 'Lighthouse', 44.1370, -124.1280, 'The most-photographed lighthouse on the Oregon coast.'],
    ['Watson Falls', 'Idleyld Park', 'Waterfall', 43.2400, -122.3900, 'A 272-foot waterfall over a mossy cliff.'],
    ['Columbia Gorge Vista House', 'Corbett', 'Architecture', 45.5390, -122.2440, 'A domed overlook above the great river canyon.'],
    ['Sparks Lake', 'Bend', 'Lake', 44.0100, -121.7400, 'Cascade peaks mirrored in an alpine lake.'],
    ['Tamanawas Falls', 'Mount Hood', 'Waterfall', 45.3900, -121.5700, 'A wide curtain waterfall you can walk behind.'],
    ['Cape Kiwanda', 'Pacific City', 'Beach', 45.2160, -123.9700, 'A sandstone headland and dune over the surf.'],
    ['Abiqua Falls', 'Scotts Mills', 'Waterfall', 44.9100, -122.4600, 'A waterfall ringed by columnar basalt.'],
  ],
  PA: [
    ['Fallingwater Cantilever', 'Mill Run', 'Architecture', 39.9060, -79.4680, 'Wright’s house cantilevered over a waterfall.'],
    ['Pittsburgh Mount Washington', 'Pittsburgh', 'Skyline', 40.4310, -80.0090, 'Three rivers and golden bridges from the overlook.'],
    ['Ricketts Glen Falls Trail', 'Benton', 'Waterfall', 41.3300, -76.2700, '21 named waterfalls along a single gorge loop.'],
    ['Pine Creek Gorge Overlook', 'Wellsboro', 'Canyon', 41.6900, -77.4500, 'The "Grand Canyon of PA" from a rim viewpoint.'],
    ['Philadelphia Art Museum Steps', 'Philadelphia', 'Architecture', 39.9656, -75.1810, 'The "Rocky Steps" and the skyline beyond.'],
    ['Gettysburg Little Round Top', 'Gettysburg', 'Historic', 39.7920, -77.2360, 'A boulder-strewn ridge over the battlefield.'],
    ['Longwood Fountains', 'Kennett Square', 'Park', 39.8700, -75.6740, 'Illuminated fountain shows in grand gardens.'],
    ['Glen Onoko Falls', 'Jim Thorpe', 'Waterfall', 40.8800, -75.7600, 'A series of waterfalls above a historic town.'],
    ['Kinzua Skywalk', 'Mount Jewett', 'Bridge', 41.7610, -78.5880, 'A glass-floored skywalk on a collapsed rail viaduct.'],
    ['Hawk Mountain', 'Kempton', 'Mountains', 40.6400, -75.9900, 'A ridge overlook famed for autumn raptor migration.'],
    ['Bushkill Falls', 'Bushkill', 'Waterfall', 41.1100, -75.0000, 'The "Niagara of Pennsylvania", eight waterfalls.'],
    ['Presque Isle', 'Erie', 'Beach', 42.1600, -80.1100, 'A sandy peninsula with lighthouses on Lake Erie.'],
    ['Ohiopyle Cucumber Falls', 'Ohiopyle', 'Waterfall', 39.8700, -79.4900, 'A bridal-veil waterfall in the Laurel Highlands.'],
    ['Hershey / Reading Pagoda', 'Reading', 'Architecture', 40.3460, -75.9100, 'A Japanese pagoda lit on a mountainside.'],
    ['McConnells Mill', 'Portersville', 'Historic', 40.9500, -80.1700, 'A covered bridge and gristmill in a rocky gorge.'],
  ],
  RI: [
    ['Newport Cliff Walk Mansions', 'Newport', 'Architecture', 41.4790, -71.3000, 'Gilded Age mansions above a clifftop ocean path.'],
    ['Beavertail Light', 'Jamestown', 'Lighthouse', 41.4490, -71.3990, 'A lighthouse on wave-battered rocks at the bay mouth.'],
    ['Block Island Mohegan Bluffs', 'Block Island', 'Beach', 41.1500, -71.5550, 'Towering clay cliffs above a hidden beach.'],
    ['Providence WaterFire', 'Providence', 'Skyline', 41.8260, -71.4090, 'Braziers blazing on the river at night.'],
    ['The Breakers Ocean', 'Newport', 'Architecture', 41.4699, -71.2986, 'A Vanderbilt palace on the Atlantic cliffs.'],
    ['Newport Harbor Yachts', 'Newport', 'Skyline', 41.4870, -71.3160, 'Sailing yachts and steeples in a classic harbor.'],
    ['Block Island Southeast Light', 'Block Island', 'Lighthouse', 41.1530, -71.5520, 'A brick Victorian lighthouse on the bluffs.'],
    ['Watch Hill Carousel', 'Westerly', 'Historic', 41.3050, -71.8580, 'The oldest flying-horse carousel in the US.'],
    ['Sachuest Surf', 'Middletown', 'Beach', 41.4790, -71.2440, 'Rocky surf and a coastal wildlife refuge.'],
    ['Roger Williams Gardens', 'Providence', 'Park', 41.7900, -71.4180, 'Victorian gardens and a domed museum.'],
    ['Point Judith Light', 'Narragansett', 'Lighthouse', 41.3610, -71.4810, 'A working lighthouse on a storied coast.'],
    ['Newport Bridge', 'Newport', 'Bridge', 41.5040, -71.3490, 'A graceful suspension bridge over Narragansett Bay.'],
    ['Narragansett Towers', 'Narragansett', 'Architecture', 41.4330, -71.4550, 'Stone towers arching over the seaside road.'],
    ['Colt State Park', 'Bristol', 'Park', 41.6700, -71.2800, 'A bayfront park of stone walls and open lawns.'],
    ['Brenton Point', 'Newport', 'Beach', 41.4520, -71.3530, 'A windswept point famous for kite-flying and sunsets.'],
  ],
  SC: [
    ['Charleston Rainbow Row Detail', 'Charleston', 'Architecture', 32.7760, -79.9270, 'Pastel Georgian row houses on the waterfront.'],
    ['Angel Oak Canopy', 'Johns Island', 'Nature', 32.7180, -80.0810, 'A 400-year-old live oak with sprawling limbs.'],
    ['Boneyard Beach Trees', 'Bulls Island', 'Beach', 32.8800, -79.6300, 'Sun-bleached oak skeletons on the sand.'],
    ['Caesars Head Overlook', 'Cleveland', 'Mountains', 35.1080, -82.6320, 'A granite overlook of the Blue Ridge escarpment.'],
    ['Charleston Battery', 'Charleston', 'Historic', 32.7700, -79.9280, 'Antebellum mansions along a seawall promenade.'],
    ['Table Rock Reservoir', 'Pickens', 'Mountains', 35.0270, -82.6980, 'A granite dome mirrored in a mountain lake.'],
    ['Hunting Island Beach', 'Hunting Island', 'Beach', 32.3760, -80.4380, 'A wild maritime-forest beach and lighthouse.'],
    ['Magnolia Plantation Bridge', 'Charleston', 'Park', 32.8870, -80.0810, 'A white bridge over a reflective garden pond.'],
    ['Congaree Boardwalk', 'Hopkins', 'Nature', 33.7930, -80.7820, 'Towering old-growth cypress on a boardwalk.'],
    ['Ravenel Bridge Detail', 'Charleston', 'Bridge', 32.8040, -79.9080, 'Diamond cables over the Cooper River.'],
    ['Myrtle Beach SkyWheel', 'Myrtle Beach', 'Beach', 33.6890, -78.8860, 'A lit observation wheel above the boardwalk.'],
    ['Cypress Gardens', 'Moncks Corner', 'Nature', 33.0500, -80.0500, 'A blackwater swamp you paddle in flat-bottom boats.'],
    ['Sassafras Mountain', 'Sunset', 'Mountains', 35.0640, -82.7770, "South Carolina's highest point with a sky bridge."],
    ['Folly Beach Pier', 'Folly Beach', 'Beach', 32.6550, -79.9400, 'A long fishing pier on a laid-back surf beach.'],
    ['Poinsett Bridge', 'Travelers Rest', 'Bridge', 35.1100, -82.4400, 'The oldest surviving bridge in the state, a Gothic arch.'],
  ],
  SD: [
    ['Mount Rushmore Faces', 'Keystone', 'Landmark', 43.8791, -103.4591, 'Four presidents carved into granite, lit at night.'],
    ['Badlands Pinnacles', 'Interior', 'Nature', 43.8554, -102.3397, 'Eroded spires glowing at sunrise.'],
    ['Needles Highway Eye', 'Custer', 'Mountains', 43.8200, -103.5000, 'Granite needles and the Needle’s Eye tunnel.'],
    ['Sylvan Lake Boulders', 'Custer', 'Lake', 43.8470, -103.5580, 'A lake encircled by giant granite boulders.'],
    ['Spearfish Canyon Falls', 'Spearfish', 'Waterfall', 44.3300, -103.9300, 'Bridal Veil and Roughlock falls in a limestone canyon.'],
    ['Crazy Horse Memorial', 'Crazy Horse', 'Landmark', 43.8360, -103.6230, 'The world’s largest mountain carving in progress.'],
    ['Custer State Park Bison', 'Custer', 'Nature', 43.7500, -103.4200, 'A 1,300-head bison herd on rolling grassland.'],
    ['Falls Park Sioux Falls', 'Sioux Falls', 'Waterfall', 43.5560, -96.7210, 'Pink-quartzite falls in the city center.'],
    ['Wind Cave Boxwork', 'Hot Springs', 'Nature', 43.5570, -103.4780, 'Rare honeycomb boxwork in a vast cave.'],
    ['Badlands Yellow Mounds', 'Interior', 'Nature', 43.7600, -102.2700, 'Banded yellow-and-red fossil soils.'],
    ['Palisades Quartzite', 'Garretson', 'Nature', 43.6900, -96.5300, 'Sheer pink quartzite cliffs over a creek.'],
    ['Roughlock Falls', 'Lead', 'Waterfall', 44.3200, -103.8800, 'A wide tiered waterfall in Spearfish Canyon.'],
    ['Cathedral Spires', 'Custer', 'Mountains', 43.8400, -103.5300, 'A cluster of soaring granite spires.'],
    ['Mount Coolidge', 'Custer', 'Mountains', 43.7300, -103.4400, 'A fire-tower summit with Black Hills panoramas.'],
    ['Bear Butte', 'Sturgis', 'Mountains', 44.4700, -103.4300, 'A sacred laccolith rising from the plains.'],
  ],
  TN: [
    ['Smokies Clingmans Dome', 'Gatlinburg', 'Mountains', 35.5628, -83.4986, 'The highest point in the park with a spiral observation ramp.'],
    ['Smokies Cades Cove', 'Townsend', 'Nature', 35.6030, -83.7770, 'A misty valley of historic cabins and wildlife.'],
    ['Roan Mountain Balds', 'Roan Mountain', 'Mountains', 36.1040, -82.1300, 'Grassy balds and the world’s largest rhododendron garden.'],
    ['Fall Creek Falls Tower', 'Spencer', 'Waterfall', 35.6620, -85.3550, 'A 256-foot waterfall in a deep gorge.'],
    ['Nashville Pedestrian Bridge', 'Nashville', 'Skyline', 36.1620, -86.7740, 'The skyline from the John Seigenthaler bridge.'],
    ['Smokies Newfound Gap', 'Gatlinburg', 'Mountains', 35.6110, -83.4250, 'A mountain pass overlook on the state line.'],
    ['Cummins Falls Pool', 'Cookeville', 'Waterfall', 36.2470, -85.5660, 'A wide waterfall and swimming hole.'],
    ['Rock Island Twin Falls', 'Rock Island', 'Waterfall', 35.8100, -85.6300, 'Waterfalls bursting from a rock face into a gorge.'],
    ['Memphis Mississippi', 'Memphis', 'Skyline', 35.1390, -90.0510, 'The river and pyramid arena at golden hour.'],
    ['Foster Falls Plateau', 'Sequatchie', 'Waterfall', 35.1800, -85.6700, 'A 60-foot plunge on the Cumberland Plateau.'],
    ['Ruby Falls Cavern', 'Chattanooga', 'Waterfall', 35.0180, -85.3390, 'A 145-foot waterfall deep inside a mountain.'],
    ['Greeter Falls', 'Altamont', 'Waterfall', 35.4200, -85.7300, 'A spiral staircase to a 50-foot waterfall and pool.'],
    ['Chattanooga Walnut Bridge', 'Chattanooga', 'Bridge', 35.0600, -85.3100, 'One of the longest pedestrian bridges in the world.'],
    ['Roan Carvers Gap', 'Roan Mountain', 'Mountains', 36.1060, -82.1100, 'A grassy bald with sweeping Appalachian ridges.'],
    ['Burgess Falls Cascades', 'Sparta', 'Waterfall', 36.0420, -85.5900, 'A series of cascades into a gorge.'],
  ],
  TX: [
    ['Big Bend Window', 'Big Bend', 'Canyon', 29.2700, -103.3000, 'A V-notch framing the desert from the Chisos Basin.'],
    ['San Antonio River Walk Night', 'San Antonio', 'Architecture', 29.4250, -98.4860, 'Lantern-lit canals and arched bridges below street level.'],
    ['Enchanted Rock Dome', 'Fredericksburg', 'Mountains', 30.5060, -98.8190, 'A pink-granite dome glowing at sunset.'],
    ['Hamilton Pool Grotto', 'Dripping Springs', 'Nature', 30.3420, -98.1270, 'A waterfall into a collapsed jade-green grotto.'],
    ['Palo Duro Lighthouse', 'Canyon', 'Canyon', 34.9370, -101.6600, 'The hoodoo spire in the second-largest US canyon.'],
    ['Big Bend Santa Elena', 'Terlingua', 'Canyon', 29.1660, -103.6100, '1,500-foot walls split by the Rio Grande.'],
    ['Austin Congress Bats', 'Austin', 'Skyline', 30.2640, -97.7450, 'Bats streaming from a bridge against the skyline.'],
    ['Marfa Prada', 'Valentine', 'Street Art', 30.6000, -104.5200, 'A lone art installation on the high-desert highway.'],
    ['Caddo Lake Bayou', 'Uncertain', 'Lake', 32.7100, -94.1000, 'Cypress draped in moss in a maze of bayous.'],
    ['Dallas Reunion Tower', 'Dallas', 'Skyline', 32.7750, -96.8090, 'The ball-topped tower and downtown skyline.'],
    ['Gorman Falls', 'Bend', 'Waterfall', 31.0200, -98.4700, 'A 70-foot travertine waterfall in Colorado Bend.'],
    ['Houston Water Wall', 'Houston', 'Architecture', 29.7350, -95.4630, 'A 64-foot horseshoe fountain wall by skyscrapers.'],
    ['Guadalupe El Capitan', 'Salt Flat', 'Mountains', 31.8910, -104.8600, 'A limestone cliff at the foot of the highest Texas peak.'],
    ['Balmorhea Springs', 'Toyahvale', 'Nature', 30.9450, -103.7860, 'A spring-fed desert pool of impossibly clear water.'],
    ['Jacob’s Well', 'Wimberley', 'Nature', 30.0340, -98.1260, 'A deep artesian spring in the Hill Country.'],
  ],
  UT: [
    ['Zion Canyon Overlook', 'Springdale', 'Canyon', 37.2130, -112.9430, 'A short trail to a sweeping canyon-mouth view.'],
    ['Bryce Inspiration Point', 'Bryce', 'Canyon', 37.6200, -112.1700, 'A vast amphitheater of orange hoodoos.'],
    ['Arches Landscape Arch', 'Moab', 'Desert', 38.7910, -109.6060, 'The longest natural arch in North America.'],
    ['Canyonlands Grand View', 'Moab', 'Canyon', 38.3100, -109.8570, 'A 1,000-foot mesa-edge panorama of canyons.'],
    ['Capitol Reef Scenic', 'Torrey', 'Desert', 38.2920, -111.2610, 'Red cliffs and the Waterpocket Fold.'],
    ['Goblin Valley', 'Green River', 'Desert', 38.5640, -110.7080, 'A valley of thousands of mushroom-shaped hoodoos.'],
    ['Park City Main', 'Park City', 'Mountains', 40.6460, -111.4980, 'A historic mining town beneath ski slopes.'],
    ['Antelope Canyon UT region / Wire Pass', 'Kanab', 'Canyon', 37.0190, -112.0250, 'A narrow slot canyon to Buckskin Gulch.'],
    ['Bonneville Salt Speed', 'Wendover', 'Desert', 40.7600, -113.8500, 'A blinding-white salt flat to the horizon.'],
    ['Zion Emerald Pools', 'Springdale', 'Waterfall', 37.2540, -112.9590, 'Hanging gardens and waterfalls on canyon walls.'],
    ['Bryce Thor’s Hammer', 'Bryce', 'Canyon', 37.6280, -112.1660, 'A balanced hoodoo on the Navajo Loop.'],
    ['Moab Fisher Towers', 'Moab', 'Desert', 38.7250, -109.3000, 'Towering red sandstone spires above the Colorado.'],
    ['Kanarraville Falls', 'Kanarraville', 'Waterfall', 37.5350, -113.1800, 'A slot canyon with a log-ladder waterfall.'],
    ['Bear Lake', 'Garden City', 'Lake', 41.9600, -111.3900, 'The "Caribbean of the Rockies" turquoise lake.'],
    ['Park Avenue Arches', 'Moab', 'Desert', 38.6080, -109.5970, 'A canyon of towering sandstone monoliths.'],
  ],
  VT: [
    ['Sleepy Hollow Farm Lane', 'Woodstock', 'Nature', 43.6360, -72.4870, 'The most-photographed autumn farm scene in Vermont.'],
    ['Stowe Community Church', 'Stowe', 'Architecture', 44.4650, -72.6870, 'A classic white steeple framed by fall foliage.'],
    ['Quechee Gorge Bridge', 'Quechee', 'Canyon', 43.6390, -72.4070, "Vermont's deepest gorge from a highway bridge."],
    ['Jenne Farm Foliage', 'Reading', 'Nature', 43.5300, -72.5500, 'An iconic red barn amid autumn hills.'],
    ['Smugglers Notch Cliffs', 'Cambridge', 'Mountains', 44.5560, -72.7900, 'A narrow pass between towering boulders.'],
    ['Lake Willoughby Fjord', 'Westmore', 'Lake', 44.7300, -72.0500, 'A glacial lake between two steep peaks.'],
    ['Moss Glen Falls Stowe', 'Stowe', 'Waterfall', 44.5300, -72.7600, 'A graceful waterfall in a hidden gorge.'],
    ['Camels Hump', 'Huntington', 'Mountains', 44.3190, -72.8850, 'A distinctive bare summit over the Champlain valley.'],
    ['Burlington Waterfront', 'Burlington', 'Lake', 44.4790, -73.2210, 'Lake Champlain sunsets behind the Adirondacks.'],
    ['Texas Falls', 'Hancock', 'Waterfall', 43.9500, -72.8600, 'Sculpted rock cascades in the Green Mountains.'],
    ['Mount Mansfield Ridge', 'Stowe', 'Mountains', 44.5440, -72.8140, 'A high alpine ridge, the state’s highest point.'],
    ['Hildene Gardens', 'Manchester', 'Architecture', 43.1500, -73.0700, 'A Lincoln-family mansion and formal gardens.'],
    ['Warren Falls', 'Warren', 'Waterfall', 44.1200, -72.8500, 'Pools and ledges along a clear mountain river.'],
    ['Lake Champlain Islands', 'South Hero', 'Lake', 44.6400, -73.3000, 'Quiet island shorelines and stone "castles".'],
    ['Bingham Falls', 'Stowe', 'Waterfall', 44.5200, -72.7900, 'A series of waterfalls and a deep emerald pool.'],
  ],
  VA: [
    ['Shenandoah Skyline Overlook', 'Luray', 'Mountains', 38.5000, -78.4500, 'Blue-layered ridge views from the famous drive.'],
    ['McAfee Knob Ledge', 'Catawba', 'Mountains', 37.3920, -80.0370, 'The famous jutting rock on the Appalachian Trail.'],
    ['Natural Bridge Arch', 'Natural Bridge', 'Nature', 37.6280, -79.5430, 'A 215-foot limestone arch in a wooded gorge.'],
    ['Great Falls Virginia', 'McLean', 'Waterfall', 38.9970, -77.2540, 'The Potomac roaring through a rocky gorge.'],
    ['Colonial Williamsburg Capitol', 'Williamsburg', 'Historic', 37.2710, -76.7000, 'Restored 18th-century brick streets and buildings.'],
    ['Chincoteague Light', 'Chincoteague', 'Lighthouse', 37.9330, -75.3580, 'A candy-striped lighthouse and wild ponies.'],
    ['Monticello Dome', 'Charlottesville', 'Architecture', 38.0080, -78.4530, 'Jefferson’s neoclassical mountaintop home.'],
    ['Crabtree Falls Tiers', 'Montebello', 'Waterfall', 37.8500, -79.0800, 'The highest cascading falls east of the Mississippi.'],
    ['Virginia Beach Neptune', 'Virginia Beach', 'Beach', 36.8520, -75.9780, 'A giant Neptune statue on the oceanfront boardwalk.'],
    ['Luray Caverns', 'Luray', 'Nature', 38.6640, -78.4840, 'Vast columns and a stalactite "organ".'],
    ['Shenandoah Dark Hollow Falls', 'Syria', 'Waterfall', 38.5200, -78.4300, 'A cascading waterfall over greenstone.'],
    ['Cape Charles', 'Cape Charles', 'Beach', 37.2680, -76.0190, 'A bayside town with western-facing sunsets.'],
    ['Devils Marbleyard', 'Natural Bridge Station', 'Nature', 37.5800, -79.4900, 'A massive boulder field on a mountainside.'],
    ['Mabry Mill', 'Meadows of Dan', 'Historic', 36.7400, -80.4050, 'A picturesque water mill on the Blue Ridge Parkway.'],
    ['Hawksbill Summit', 'Luray', 'Mountains', 38.5560, -78.3880, 'The highest peak in Shenandoah National Park.'],
  ],
  WA: [
    ['Rainier Reflection Lakes', 'Ashford', 'Mountains', 46.7700, -121.7300, 'The volcano mirrored in alpine lakes and meadows.'],
    ['Seattle Kerry Park', 'Seattle', 'Skyline', 47.6295, -122.3600, 'The classic skyline, Space Needle, and Rainier view.'],
    ['Diablo Lake Overlook', 'Newhalem', 'Lake', 48.7140, -121.1360, 'A turquoise glacial lake in the North Cascades.'],
    ['Snoqualmie Falls Lodge', 'Snoqualmie', 'Waterfall', 47.5417, -121.8377, 'A 268-foot waterfall taller than Niagara.'],
    ['Ruby Beach Sea Stacks', 'Forks', 'Beach', 47.7100, -124.4150, 'Driftwood and sea stacks on a wild coast.'],
    ['Palouse Falls Canyon', 'LaCrosse', 'Waterfall', 46.6640, -118.2240, "Washington's state waterfall in a desert canyon."],
    ['Hoh Rainforest Moss', 'Forks', 'Nature', 47.8600, -123.9350, 'Moss-draped old-growth in a temperate rainforest.'],
    ['Mount Baker Artist Point', 'Glacier', 'Mountains', 48.8450, -121.6900, 'Glaciated peaks and meadows at road’s end.'],
    ['Deception Pass Bridge', 'Oak Harbor', 'Bridge', 48.4060, -122.6470, 'A high bridge over churning tidal narrows.'],
    ['Cape Disappointment Light', 'Ilwaco', 'Lighthouse', 46.2750, -124.0520, 'A lighthouse where the Columbia meets the Pacific.'],
    ['Palouse Steptoe Butte', 'Colfax', 'Nature', 47.0300, -117.3000, 'Rolling green-and-gold farm hills from a butte.'],
    ['Mount St. Helens Crater', 'Toutle', 'Mountains', 46.1910, -122.1950, 'The blown-out crater of the 1980 eruption.'],
    ['Olympic Hurricane Ridge', 'Port Angeles', 'Mountains', 47.9690, -123.4980, 'A ridge of meadows and glaciated peaks.'],
    ['Spokane Falls', 'Spokane', 'Waterfall', 47.6610, -117.4250, 'Urban waterfalls in the heart of downtown.'],
    ['Wallace Falls', 'Gold Bar', 'Waterfall', 47.8700, -121.6800, 'A 265-foot waterfall on a forested trail.'],
  ],
  WV: [
    ['New River Gorge Overlook', 'Fayetteville', 'Bridge', 38.0700, -81.0760, 'The famous steel arch over a forested gorge.'],
    ['Blackwater Falls Amber', 'Davis', 'Waterfall', 39.1130, -79.4900, 'Amber waters dropping 57 feet in a canyon.'],
    ['Seneca Rocks Fin', 'Seneca Rocks', 'Mountains', 38.8350, -79.3730, 'A sheer 900-foot quartzite fin above the valley.'],
    ['Glade Creek Grist Mill', 'Clifftop', 'Historic', 37.8200, -80.9300, 'A working mill beside a creek in Babcock.'],
    ['Dolly Sods Plateau', 'Hopeville', 'Nature', 39.0300, -79.3300, 'A windswept high plateau of bogs and one-sided spruce.'],
    ['Grandview Horseshoe', 'Beaver', 'Canyon', 37.8300, -81.0600, 'A horseshoe bend of the New River from a clifftop.'],
    ['Coopers Rock Cliff', 'Morgantown', 'Canyon', 39.6600, -79.7900, 'A clifftop overlook of the Cheat River gorge.'],
    ['Sandstone Falls', 'Hinton', 'Waterfall', 37.7700, -80.8900, 'The widest waterfall on the New River.'],
    ['Spruce Knob Tower', 'Riverton', 'Mountains', 38.6990, -79.5320, 'A stone tower on the highest point in the state.'],
    ['Harpers Ferry Overlook', 'Harpers Ferry', 'Historic', 39.3260, -77.7290, 'A historic town at a dramatic river confluence.'],
    ['Babcock Mill Autumn', 'Clifftop', 'Historic', 38.0300, -80.9500, 'The iconic mill ablaze with fall color.'],
    ['Cathedral Falls', 'Gauley Bridge', 'Waterfall', 38.1700, -81.2000, 'A 60-foot roadside waterfall over mossy rock.'],
    ['Bear Rocks Preserve', 'Davis', 'Nature', 39.0500, -79.2900, 'Wind-sculpted rocks and heath on a high ridge.'],
    ['Summersville Lake', 'Summersville', 'Lake', 38.2200, -80.8900, 'Sheer cliffs above clear emerald water.'],
    ['Hawks Nest', 'Ansted', 'Canyon', 38.1200, -81.1200, 'An overlook of the New River Gorge from a state park.'],
  ],
  WI: [
    ['Apostle Islands Ice Caves', 'Bayfield', 'Beach', 46.9300, -90.6600, 'Sea caves that freeze into ice cathedrals in winter.'],
    ['Devils Lake Bluffs', 'Baraboo', 'Lake', 43.4280, -89.7300, '500-foot quartzite bluffs over a clear lake.'],
    ['Wisconsin Dells Gorge', 'Wisconsin Dells', 'Canyon', 43.6270, -89.7710, 'Sandstone cliffs along a winding river.'],
    ['Cave Point Cliffs', 'Sturgeon Bay', 'Beach', 44.9200, -87.2700, 'Limestone cliffs and caves on Lake Michigan.'],
    ['Milwaukee Art Museum Wings', 'Milwaukee', 'Architecture', 43.0400, -87.8970, "Calatrava's winged sunscreen over the lake."],
    ['Cana Island Light', 'Baileys Harbor', 'Lighthouse', 45.0890, -87.0500, 'A lighthouse on a rocky causeway in Door County.'],
    ['Pewits Nest Slot', 'Baraboo', 'Canyon', 43.4600, -89.7900, 'A hidden slot gorge with waterfalls.'],
    ['Big Manitou Falls', 'Superior', 'Waterfall', 46.5300, -91.8500, 'The highest waterfall in Wisconsin at 165 feet.'],
    ['Holy Hill Basilica', 'Hubertus', 'Architecture', 43.2500, -88.2900, 'A twin-spired basilica above autumn forest.'],
    ['Lake Geneva Shore Path', 'Lake Geneva', 'Lake', 42.5910, -88.4330, 'A path past Gilded Age lakefront estates.'],
    ['Parfreys Glen', 'Merrimac', 'Canyon', 43.4200, -89.6300, 'A mossy sandstone gorge with embedded boulders.'],
    ['Door County Eagle Bluff', 'Fish Creek', 'Lighthouse', 45.1700, -87.2200, 'An 1868 lighthouse on a forested bluff.'],
    ['Willow River Falls', 'Hudson', 'Waterfall', 45.0200, -92.6900, 'A wide cascading waterfall in a river gorge.'],
    ['High Cliff State Park', 'Sherwood', 'Mountains', 44.1600, -88.2900, 'Limestone cliffs over Lake Winnebago.'],
    ['Amnicon Falls', 'South Range', 'Waterfall', 46.6100, -91.8900, 'Root-beer-colored waterfalls and a covered bridge.'],
  ],
  WY: [
    ['Teton Schwabacher Landing', 'Moose', 'Mountains', 43.7900, -110.6800, 'The Tetons mirrored in a quiet Snake River channel.'],
    ['Grand Prismatic Overlook', 'Yellowstone', 'Nature', 44.5250, -110.8380, 'A rainbow-ringed hot spring from above.'],
    ['Yellowstone Lower Falls', 'Yellowstone', 'Waterfall', 44.7180, -110.4960, 'A 308-foot waterfall in a golden canyon.'],
    ['Mormon Row Barn', 'Moose', 'Historic', 43.7350, -110.6500, 'The most-photographed barn in America below the Tetons.'],
    ['Jenny Lake Hidden Falls', 'Moose', 'Lake', 43.7600, -110.7200, 'A glassy lake and waterfall at the foot of the peaks.'],
    ['Devils Tower Monolith', 'Devils Tower', 'Nature', 44.5902, -104.7146, 'An 867-foot volcanic monolith on the plains.'],
    ['Mammoth Terraces', 'Yellowstone', 'Nature', 44.9700, -110.7000, 'Travertine terraces like a frozen waterfall.'],
    ['Snake River Overlook', 'Moose', 'Mountains', 43.7400, -110.6300, 'Ansel Adams’ famous river-and-Tetons vista.'],
    ['Oxbow Bend', 'Moran', 'Mountains', 43.8650, -110.5470, 'Mount Moran mirrored in a calm river bend.'],
    ['Old Faithful Eruption', 'Yellowstone', 'Nature', 44.4605, -110.8281, 'The world’s most famous geyser erupting on schedule.'],
    ['Hot Springs State Park', 'Thermopolis', 'Nature', 43.6500, -108.2000, 'The world’s largest mineral hot spring terraces.'],
    ['Vedauwoo', 'Laramie', 'Desert', 41.1600, -105.3800, 'Otherworldly piled granite formations.'],
    ['Brooks Lake', 'Dubois', 'Lake', 43.7500, -110.0000, 'A lake below dramatic pinnacle cliffs.'],
    ['Sinks Canyon', 'Lander', 'Canyon', 42.7400, -108.8100, 'A river that vanishes into a cave and reappears.'],
    ['Yellowstone Lake', 'Yellowstone', 'Lake', 44.4600, -110.3700, 'The largest high-elevation lake in North America.'],
  ],
}

// ─── SUPPLEMENTAL 2 (top-up to ~30/state) ────────────────────────────────────
const RAW_EXTRA2: Record<string, Raw[]> = {
  CT: [
    ['Avery Point Light', 'Groton', 'Lighthouse', 41.3150, -72.0640, 'The last lighthouse built in Connecticut, on a university point.'],
    ['Cornwall Covered Bridge', 'Cornwall', 'Bridge', 41.8200, -73.3500, 'A historic red covered bridge over the Housatonic.'],
    ['Mohawk Mountain', 'Cornwall', 'Mountains', 41.8300, -73.3100, 'A ridge overlook of the Litchfield Hills.'],
    ['Hartford Capitol', 'Hartford', 'Architecture', 41.7620, -72.6820, 'A gold-domed Gothic capitol above Bushnell Park.'],
    ['Hammonasset Meigs Point', 'Madison', 'Beach', 41.2640, -72.5350, 'Rocky shore and salt marsh on Long Island Sound.'],
  ],
  DE: [
    ['Fenwick Lighthouse Detail', 'Fenwick Island', 'Lighthouse', 38.4600, -75.0490, 'An 1859 tower on the transpeninsular line.'],
    ['New Castle Green', 'New Castle', 'Historic', 39.6580, -75.5620, 'A cobblestone colonial town green on the river.'],
    ['Alapocas Run', 'Wilmington', 'Nature', 39.7800, -75.5600, 'A blue-rock quarry and creek gorge in the city.'],
    ['Port Penn Marsh', 'Port Penn', 'Nature', 39.5100, -75.5800, 'Tidal marsh boardwalks along the Delaware.'],
    ['Bethany Beach Boardwalk', 'Bethany Beach', 'Beach', 38.5390, -75.0560, 'A quiet family boardwalk on the Atlantic.'],
  ],
  GA: [
    ['Providence Canyon Floor', 'Lumpkin', 'Canyon', 32.0700, -84.9120, 'Pink-and-white clay gullies of the "Little Grand Canyon".'],
    ['Forsyth Fountain Detail', 'Savannah', 'Park', 32.0560, -81.0960, 'The white fountain beneath moss-draped oaks.'],
    ['Panola Mountain', 'Stockbridge', 'Mountains', 33.6300, -84.1700, 'A protected granite monadnock near Atlanta.'],
    ['Savannah Wormsloe', 'Savannah', 'Historic', 31.9600, -81.0600, 'A 1.5-mile avenue of live oaks to tabby ruins.'],
    ['Lake Lanier', 'Buford', 'Lake', 34.1700, -84.0700, 'A vast reservoir of forested coves and islands.'],
  ],
  HI: [
    ['Shipwreck Beach', 'Koloa', 'Beach', 21.8770, -159.4350, 'Golden cliffs and surf on Kauai’s south shore.'],
    ['Lanai Hulopoe Bay', 'Lanai City', 'Beach', 20.7400, -156.8900, 'A pristine marine-preserve bay with spinner dolphins.'],
    ['Molokai Kalaupapa', 'Kalaupapa', 'Mountains', 21.1900, -156.9800, 'The world’s tallest sea cliffs above a remote peninsula.'],
    ['Waipio Valley', 'Honokaa', 'Mountains', 20.1170, -155.5860, 'A lush "Valley of the Kings" with a black-sand beach.'],
    ['Pololu Valley', 'Hawi', 'Mountains', 20.2050, -155.7350, 'A green valley and black-sand bay on the Big Island.'],
  ],
  IA: [
    ['Cedar Rock Wright House', 'Quasqueton', 'Architecture', 42.3900, -91.7600, 'A Frank Lloyd Wright Usonian home above a river.'],
    ['Bridges Cedar Bridge', 'Winterset', 'Bridge', 41.3300, -94.0000, 'A rebuilt covered bridge of Madison County.'],
    ['Wabash Trace', 'Shenandoah', 'Nature', 40.7600, -95.3700, 'A wooded rail-trail through rolling farm country.'],
    ['Dubuque Bluffs', 'Dubuque', 'Skyline', 42.5000, -90.6600, 'River bluffs and a funicular over the Mississippi.'],
    ['Lake Macbride', 'Solon', 'Lake', 41.7900, -91.5500, "Iowa's largest state-park lake amid wooded hills."],
  ],
  IL: [
    ['Cloud Gate Reflection', 'Chicago', 'Street Art', 41.8827, -87.6233, 'The mirrored Bean reflecting the skyline up close.'],
    ['Castle Rock IL', 'Oregon', 'Nature', 42.0000, -89.3300, 'A sandstone butte above the Rock River.'],
    ['Chicago Marina City', 'Chicago', 'Architecture', 41.8880, -87.6320, 'The "corncob" towers over the river.'],
    ['Volo Bog', 'Ingleside', 'Nature', 42.3500, -88.1800, 'A rare quaking bog with a floating boardwalk.'],
    ['Mississippi Palisades', 'Savanna', 'Canyon', 42.1300, -90.1600, 'Limestone bluffs above the Mississippi River.'],
  ],
  IN: [
    ['Indiana Dunes Devil’s Slide', 'Chesterton', 'Beach', 41.6500, -87.0600, 'A steep dune trail down to the lakeshore.'],
    ['Bluespring Caverns', 'Bedford', 'Nature', 38.8400, -86.5300, 'A boat tour on an underground river.'],
    ['Indiana State Capitol', 'Indianapolis', 'Architecture', 39.7684, -86.1623, 'A limestone-and-glass-domed statehouse.'],
    ['Pine Hills Nature', 'Waveland', 'Canyon', 39.9300, -87.0500, 'Knife-edge sandstone "backbones" over creeks.'],
    ['Wabash River', 'Lafayette', 'Nature', 40.4200, -86.9000, 'A wide river and historic battlegrounds.'],
  ],
  KS: [
    ['Kanopolis Mushroom', 'Marquette', 'Nature', 38.6200, -98.0300, 'Sandstone caves and mushroom rocks by a lake.'],
    ['Chase County Falls', 'Cottonwood Falls', 'Waterfall', 38.3700, -96.5400, 'A low prairie waterfall on the Cottonwood River.'],
    ['Wilson Lake', 'Sylvan Grove', 'Lake', 38.9300, -98.5000, 'The clearest lake in Kansas amid Dakota sandstone.'],
    ['Flint Hills Tallgrass Vista', 'Strong City', 'Nature', 38.4300, -96.5600, 'Endless tallgrass under a wide sky.'],
    ['Cimarron Grassland', 'Elkhart', 'Desert', 37.0500, -101.8900, 'Sand sage prairie and Santa Fe Trail ruts.'],
  ],
  KY: [
    ['Red River Gorge Natural Arch', 'Slade', 'Nature', 37.8100, -83.6800, 'A dramatic sandstone arch in the gorge.'],
    ['Falls of the Ohio KY', 'Louisville', 'Nature', 38.2700, -85.7700, 'Fossil beds along the Ohio River rapids.'],
    ['Breaks Interstate Park', 'Elkhorn City', 'Canyon', 37.2900, -82.2900, 'The "Grand Canyon of the South" on the Virginia line.'],
    ['Dog Slaughter Falls', 'Corbin', 'Waterfall', 36.8700, -84.2900, 'A 15-foot waterfall on a forested creek.'],
    ['Lake Cumberland', 'Jamestown', 'Lake', 36.9200, -85.1400, 'A sprawling reservoir of cliff-lined coves.'],
  ],
  LA: [
    ['St. Louis Cemetery No. 1', 'New Orleans', 'Historic', 29.9600, -90.0710, 'Above-ground tombs in a famous old cemetery.'],
    ['Tabasco Avery Marsh', 'Avery Island', 'Nature', 29.9000, -91.9100, 'Marsh boardwalks and a Buddhist temple garden.'],
    ['Lake Pontchartrain Causeway', 'Mandeville', 'Bridge', 30.2000, -90.1100, 'The longest continuous bridge over water in the US.'],
    ['Chicot State Park', 'Ville Platte', 'Lake', 30.7900, -92.2700, 'A cypress-ringed lake with reflective water.'],
    ['Rosedown Plantation', 'St. Francisville', 'Historic', 30.7900, -91.3700, 'A restored mansion with formal historic gardens.'],
  ],
  MA: [
    ['Cape Cod Race Point', 'Provincetown', 'Beach', 42.0700, -70.2400, 'Wild dunes and surf at the very tip of the Cape.'],
    ['Mohawk Trail Hairpin', 'North Adams', 'Mountains', 42.6900, -73.0700, 'A famous hairpin turn with Berkshire views.'],
    ['Boston North End', 'Boston', 'Historic', 42.3650, -71.0540, 'Narrow colonial streets and the Old North Church.'],
    ['Chesterfield Gorge', 'Chesterfield', 'Canyon', 42.3900, -72.8300, 'A granite gorge on the wild Westfield River.'],
    ['Plum Island', 'Newburyport', 'Beach', 42.7500, -70.8200, 'Dunes and a wildlife refuge on a barrier island.'],
  ],
  MD: [
    ['Concord Point Light', 'Havre de Grace', 'Lighthouse', 39.5400, -76.0900, 'An 1827 lighthouse where the Susquehanna meets the bay.'],
    ['Maryland Capitol Annapolis', 'Annapolis', 'Architecture', 38.9790, -76.4910, 'The oldest US capitol in continuous legislative use.'],
    ['Deep Creek Lake', 'McHenry', 'Lake', 39.5100, -79.3000, "Maryland's largest lake in the western mountains."],
    ['Wye Oak / Eastern Shore', 'Easton', 'Nature', 38.7700, -76.0700, 'Tidewater farmland and historic Eastern Shore towns.'],
    ['Catoctin Wolf Rock', 'Thurmont', 'Nature', 39.6400, -77.4500, 'A quartzite outcrop in mountain hardwood forest.'],
  ],
  ME: [
    ['Acadia Thunder Hole', 'Bar Harbor', 'Beach', 44.3190, -68.1900, 'Booming waves in a rocky inlet.'],
    ['Bug Light', 'South Portland', 'Lighthouse', 43.6560, -70.2330, 'A tiny ornate lighthouse on Casco Bay.'],
    ['Wells Reserve', 'Wells', 'Beach', 43.3400, -70.5500, 'Salt marsh and dune trails to a quiet beach.'],
    ['Grafton Notch', 'Newry', 'Waterfall', 44.5900, -70.9300, 'Screw Auger Falls and gorges in the western mountains.'],
    ['Owls Head Light', 'Owls Head', 'Lighthouse', 44.0920, -69.0440, 'A short lighthouse on a rocky headland.'],
  ],
  MI: [
    ['Sleeping Bear Pierce Stocking', 'Empire', 'Beach', 44.8900, -86.0600, 'A scenic drive to dune overlooks of Lake Michigan.'],
    ['Au Sable Light', 'Grand Marais', 'Lighthouse', 46.6700, -86.1400, 'A remote lighthouse along Pictured Rocks.'],
    ['Lake of the Clouds Overlook', 'Ontonagon', 'Lake', 46.8200, -89.7400, 'The famous Porcupine Mountains lake vista.'],
    ['Mackinac Fort', 'Mackinac Island', 'Historic', 45.8500, -84.6180, 'A white-walled fort above the harbor.'],
    ['Saugatuck Dunes', 'Saugatuck', 'Beach', 42.7100, -86.2100, 'Forested dunes plunging to a quiet beach.'],
  ],
  MN: [
    ['Duluth Aerial Lift Bridge', 'Duluth', 'Bridge', 46.7800, -92.0900, 'A lift bridge framing ore boats on Lake Superior.'],
    ['Temperance River Gorge', 'Schroeder', 'Canyon', 47.5500, -90.8700, 'A river carving deep potholes into rock.'],
    ['Pipestone Falls', 'Pipestone', 'Waterfall', 44.0100, -96.3300, 'Winnewissa Falls amid sacred red pipestone quarries.'],
    ['Grand Portage Bay', 'Grand Portage', 'Lake', 47.9600, -89.6800, 'A historic fur-trade depot on Superior.'],
    ['Blue Mounds', 'Luverne', 'Nature', 43.7100, -96.1900, 'A Sioux quartzite cliff and prairie bison herd.'],
  ],
  MO: [
    ['Meramec Caverns', 'Sullivan', 'Nature', 38.2100, -91.0900, 'A famous show cave with a giant "wine table".'],
    ['Current River', 'Eminence', 'Nature', 37.1500, -91.3600, 'A spring-fed clear river for floating, below bluffs.'],
    ['Bridal Cave', 'Camdenton', 'Nature', 38.0600, -92.7300, 'A cave of dense columns above Lake of the Ozarks.'],
    ['Rocheport Tunnel', 'Rocheport', 'Historic', 38.9800, -92.5600, 'A rail-trail tunnel through a river bluff.'],
    ['Hawn State Park', 'Sainte Genevieve', 'Nature', 37.8300, -90.2400, 'Pink sandstone canyons and pine-shaded creeks.'],
  ],
  MS: [
    ['Tupelo Elvis Birthplace', 'Tupelo', 'Historic', 34.2570, -88.6970, 'A modest two-room house and chapel.'],
    ['Mississippi Petrified Forest Trail', 'Flora', 'Nature', 32.5500, -90.3100, 'A trail past ancient fossil logs.'],
    ['Natchez Under-the-Hill', 'Natchez', 'Historic', 31.5570, -91.4100, 'A riverfront row of old saloons below the bluff.'],
    ['Gulfport Harbor', 'Gulfport', 'Skyline', 30.3600, -89.0900, 'A marina and beach on the Mississippi Sound.'],
    ['Legion State Park', 'Louisville', 'Lake', 33.1500, -89.0300, 'A CCC-built lodge above a still lake.'],
  ],
  MT: [
    ['Glacier Logan Pass Meadows', 'West Glacier', 'Mountains', 48.6960, -113.7180, 'Wildflower meadows below jagged peaks.'],
    ['Pompeys Pillar', 'Pompeys Pillar', 'Historic', 45.9970, -107.9560, 'A sandstone butte bearing Clark’s 1806 signature.'],
    ['Lewis & Clark Caverns', 'Whitehall', 'Nature', 45.8400, -111.8700, 'One of the most decorated limestone caves in the US.'],
    ['Madison River', 'Ennis', 'Nature', 45.3500, -111.7300, 'A famous trout river beneath the Madison Range.'],
    ['Glacier Sun Point', 'St. Mary', 'Lake', 48.6800, -113.5500, 'A windswept point over St. Mary Lake.'],
  ],
  NC: [
    ['Blue Ridge Craggy Gardens', 'Asheville', 'Mountains', 35.7000, -82.3800, 'Rhododendron balds and sweeping parkway vistas.'],
    ['Hanging Rock', 'Danbury', 'Mountains', 36.3900, -80.2600, 'Quartzite cliffs, waterfalls, and a summit view.'],
    ['Bald Head Island', 'Bald Head Island', 'Lighthouse', 33.8650, -77.9600, '"Old Baldy", the oldest lighthouse in the state.'],
    ['Sliding Rock', 'Pisgah Forest', 'Waterfall', 35.3100, -82.7900, 'A natural 60-foot rock waterslide in Pisgah.'],
    ['Pilot Mountain', 'Pinnacle', 'Mountains', 36.3400, -80.4700, 'A distinctive quartzite knob rising from the Piedmont.'],
  ],
  ND: [
    ['Fort Abraham Lincoln', 'Mandan', 'Historic', 46.7600, -100.8500, 'Reconstructed cavalry post and earthlodges on the river.'],
    ['Cross Ranch', 'Center', 'Nature', 47.2200, -101.0800, 'Cottonwood bottomlands along a free-flowing Missouri.'],
    ['Killdeer Mountains', 'Killdeer', 'Mountains', 47.3500, -102.7900, 'Forested buttes rising above the prairie.'],
    ['Lake Tschida', 'Glen Ullin', 'Lake', 46.6000, -101.7600, 'A reservoir in badlands-fringed grassland.'],
    ['Chateau de Mores', 'Medora', 'Historic', 46.9100, -103.5300, 'A French nobleman’s 1883 hunting chateau.'],
  ],
  NE: [
    ['Smith Falls Canoe', 'Valentine', 'Waterfall', 42.8900, -100.3000, 'The state’s tallest falls reached by river.'],
    ['Robidoux Pass', 'Gering', 'Nature', 41.7900, -103.8500, 'Oregon Trail ruts through bluff country.'],
    ['Niobrara Confluence', 'Niobrara', 'Nature', 42.7600, -98.0300, 'Where the Niobrara meets the Missouri.'],
    ['Ponca State Park', 'Ponca', 'Nature', 42.6000, -96.7100, 'Wooded bluffs over the last wild stretch of the Missouri.'],
    ['Henry Doorly Gardens', 'Omaha', 'Park', 41.2200, -95.9200, 'A lush conservatory and botanical gardens.'],
  ],
  NH: [
    ['Glen Ellis Falls', 'Jackson', 'Waterfall', 44.2500, -71.2500, 'A 64-foot waterfall in Pinkham Notch.'],
    ['Lake Chocorua Reflection', 'Tamworth', 'Lake', 43.8950, -71.2600, 'The classic peak mirrored in a still lake.'],
    ['Mount Washington Hotel', 'Bretton Woods', 'Architecture', 44.2580, -71.4410, 'A grand white resort below the Presidential Range.'],
    ['Lost River Gorge', 'North Woodstock', 'Canyon', 44.0400, -71.7900, 'Caves and a boardwalk through a glacial gorge.'],
    ['Rye Coast', 'Rye', 'Beach', 43.0140, -70.7300, 'Rocky tide pools along the short NH seacoast.'],
  ],
  NJ: [
    ['Cape May Sunset Diamonds', 'Cape May', 'Beach', 38.9300, -74.9700, 'A pebble beach at the southern tip.'],
    ['Hacklebarney', 'Long Valley', 'Waterfall', 40.7600, -74.7400, 'A rocky river gorge with small cascades.'],
    ['Round Valley Reservoir', 'Lebanon', 'Lake', 40.6300, -74.8400, 'A deep, clear horseshoe-shaped reservoir.'],
    ['Absecon Lighthouse', 'Atlantic City', 'Lighthouse', 39.3660, -74.4160, "New Jersey's tallest lighthouse."],
    ['Ringwood Manor', 'Ringwood', 'Historic', 41.1200, -74.2500, 'A historic ironmaster’s estate and gardens.'],
  ],
  NY: [
    ['Kaaterskill Falls', 'Haines Falls', 'Waterfall', 42.1960, -74.0600, 'A 260-foot two-tier waterfall painted by the Hudson River School.'],
    ['Storm King Wall', 'New Windsor', 'Street Art', 41.4250, -74.0570, 'Andy Goldsworthy’s stone wall winding through a sculpture park.'],
    ['Montauk Point Light', 'Montauk', 'Lighthouse', 41.0710, -71.8570, 'New York’s oldest lighthouse on the eastern tip of Long Island.'],
    ['Watkins Glen Rainbow', 'Watkins Glen', 'Waterfall', 42.3740, -76.8710, 'A footbridge beneath a misted waterfall in the gorge.'],
    ['Hudson Walkway', 'Poughkeepsie', 'Bridge', 41.7080, -73.9460, 'The longest elevated pedestrian bridge in the world over the Hudson.'],
  ],
  NM: [
    ['Ghost Ranch', 'Abiquiu', 'Desert', 36.3300, -106.4800, "Red-and-yellow cliffs painted by Georgia O'Keeffe."],
    ['Three Rivers Petroglyphs', 'Tularosa', 'Historic', 33.3400, -105.8600, 'Thousands of ancient rock carvings on a desert ridge.'],
    ['Soda Dam', 'Jemez Springs', 'Nature', 35.8000, -106.6900, 'A travertine dam over a hot-spring river.'],
    ['Wheeler Peak NM', 'Taos', 'Mountains', 36.5570, -105.4170, "New Mexico's highest peak above alpine lakes."],
    ['Bandelier Tyuonyi', 'Los Alamos', 'Historic', 35.7780, -106.2700, 'Cliff cavates and pueblo ruins in a canyon.'],
  ],
  NV: [
    ['Valley of Fire Elephant Rock', 'Overton', 'Desert', 36.4400, -114.5000, 'A natural arch shaped like an elephant.'],
    ['Tahoe Bonsai Rock', 'Incline Village', 'Lake', 39.2200, -119.9300, 'A boulder topped with tiny pines in clear water.'],
    ['Goldfield Ghost Town', 'Goldfield', 'Historic', 37.7080, -117.2360, 'A faded mining boomtown on Highway 95.'],
    ['Ruby Lake', 'Ruby Valley', 'Lake', 40.2000, -115.5000, 'A marsh refuge below the Ruby Mountains.'],
    ['Sand Mountain', 'Fallon', 'Desert', 39.3000, -118.4000, 'A 600-foot "singing" sand dune in the desert.'],
  ],
  OH: [
    ['Hocking Rock House', 'Laurelville', 'Canyon', 39.4900, -82.6200, 'A rare tunnel-like recess cave in a cliff.'],
    ['Cincinnati Skyline Devou', 'Covington', 'Skyline', 39.0900, -84.5300, 'The skyline and river from a hilltop park.'],
    ['Glacial Grooves Kelleys', 'Kelleys Island', 'Nature', 41.6000, -82.7100, 'The largest accessible glacial grooves on Earth.'],
    ['Hocking Cantwell Cliffs', 'Rockbridge', 'Canyon', 39.5200, -82.6000, 'Towering cliffs and a narrow "Fat Woman’s Squeeze".'],
    ['Cedar Bog', 'Urbana', 'Nature', 40.0600, -83.8200, 'A rare boardwalk fen of unusual plants.'],
  ],
  OK: [
    ['Wichita Refuge Mount Scott', 'Lawton', 'Mountains', 34.7400, -98.5300, 'A summit road to wide views of the range.'],
    ['Chickasaw Recreation', 'Sulphur', 'Nature', 34.5000, -96.9700, 'Mineral springs, streams, and small waterfalls.'],
    ['Honey Creek Falls', 'Davis', 'Waterfall', 34.4300, -97.1400, 'A small waterfall beside the larger Turner Falls.'],
    ['Quartz Mountain', 'Lone Wolf', 'Mountains', 34.9000, -99.3000, 'Granite peaks above a clear lake.'],
    ['Gloss Mountain Mesa Trail', 'Fairview', 'Mountains', 36.3400, -98.5600, 'A mesa-top trail glittering with selenite.'],
  ],
  OR: [
    ['Toketee Falls Basalt', 'Idleyld Park', 'Waterfall', 43.2660, -122.4230, 'A waterfall framed by columnar basalt.'],
    ['Latourell Falls', 'Corbett', 'Waterfall', 45.5380, -122.2180, 'A 249-foot waterfall over bright green basalt.'],
    ['Crater Lake Wizard Island', 'Crater Lake', 'Lake', 42.9430, -122.1700, 'A cinder-cone island in the deep blue caldera.'],
    ['Samuel Boardman Coast', 'Brookings', 'Beach', 42.1100, -124.3500, 'Sea arches and stacks along a scenic corridor.'],
    ['Silver Falls Canyon', 'Sublimity', 'Waterfall', 44.8780, -122.6560, 'A trail behind ten waterfalls in a forest canyon.'],
  ],
  PA: [
    ['Raymondskill Falls', 'Dingmans Ferry', 'Waterfall', 41.2300, -74.9000, "Pennsylvania's tallest waterfall in the Poconos."],
    ['Cherry Springs Dark Sky', 'Coudersport', 'Nature', 41.6640, -77.8260, 'One of the darkest night skies in the eastern US.'],
    ['Boathouse Row', 'Philadelphia', 'Skyline', 39.9690, -75.1860, 'Historic rowing clubs outlined in lights on the river.'],
    ['Bushkill Main Falls', 'Bushkill', 'Waterfall', 41.1100, -75.0000, 'The main 100-foot falls of the "Niagara of PA".'],
    ['Laurel Hill', 'Somerset', 'Mountains', 40.0000, -79.2000, 'Forested ridgelines of the Laurel Highlands.'],
  ],
  RI: [
    ['Castle Hill Light', 'Newport', 'Lighthouse', 41.4620, -71.3630, 'A small lighthouse on the rocks at the bay entrance.'],
    ['Fort Adams', 'Newport', 'Historic', 41.4790, -71.3390, 'A massive coastal fortress on the harbor.'],
    ['Lincoln Woods', 'Lincoln', 'Lake', 41.9200, -71.4300, 'A wooded park of boulders around a pond.'],
    ['Trinity Church Newport', 'Newport', 'Architecture', 41.4880, -71.3120, 'A white colonial church with a tiered steeple.'],
    ['Rose Island Light', 'Newport', 'Lighthouse', 41.4920, -71.3430, 'A restored island lighthouse in the bay.'],
  ],
  SC: [
    ['Charleston Pineapple Fountain', 'Charleston', 'Park', 32.7740, -79.9270, 'A waterfront fountain in Waterfront Park.'],
    ['Jones Gap Falls', 'Marietta', 'Waterfall', 35.1300, -82.5800, 'Waterfalls along the wild Middle Saluda River.'],
    ['Edisto Beach', 'Edisto Island', 'Beach', 32.5000, -80.3000, 'A quiet, unspoiled barrier-island beach.'],
    ['Raven Cliff Falls', 'Cleveland', 'Waterfall', 35.1100, -82.6700, 'A 400-foot waterfall viewed from a trail overlook.'],
    ['Cowpens Battlefield', 'Gaffney', 'Historic', 35.1300, -81.8100, 'Rolling fields of a Revolutionary War victory.'],
  ],
  SD: [
    ['Iron Mountain Road', 'Keystone', 'Mountains', 43.8700, -103.4100, 'Pigtail bridges and tunnels framing Mount Rushmore.'],
    ['Minuteman Missile', 'Philip', 'Historic', 43.8800, -101.9400, 'A preserved Cold War missile silo on the plains.'],
    ['Badlands Door Trail', 'Interior', 'Nature', 43.8700, -101.9300, 'A boardwalk into eroded badlands formations.'],
    ['Sica Hollow', 'Sisseton', 'Nature', 45.7400, -97.2300, 'A legend-rich wooded ravine with bog springs.'],
    ['Big Stone Lake', 'Milbank', 'Lake', 45.3000, -96.6500, 'A long glacial lake on the Minnesota border.'],
  ],
  TN: [
    ['Smokies Laurel Falls', 'Gatlinburg', 'Waterfall', 35.6800, -83.5900, 'An 80-foot waterfall on a popular paved trail.'],
    ['Ober Gatlinburg View', 'Gatlinburg', 'Skyline', 35.7050, -83.5170, 'A tramway to mountain views over the town.'],
    ['Reelfoot Lake', 'Tiptonville', 'Lake', 36.3800, -89.3800, 'A cypress lake formed by an 1811 earthquake.'],
    ['Nashville Parthenon', 'Nashville', 'Architecture', 36.1490, -86.8130, 'A full-scale replica of the Athenian Parthenon.'],
    ['Bald River Falls', 'Tellico Plains', 'Waterfall', 35.3200, -84.1800, 'A roadside 90-foot waterfall in the Cherokee forest.'],
  ],
  TX: [
    ['Big Bend Boquillas', 'Big Bend', 'Canyon', 29.1800, -102.9300, 'Towering canyon walls along the Rio Grande.'],
    ['McDonald Observatory', 'Fort Davis', 'Nature', 30.6720, -104.0250, 'Dark-sky domes in the Davis Mountains.'],
    ['Pedernales Falls', 'Johnson City', 'Waterfall', 30.3100, -98.2500, 'Stair-stepped river falls over slabbed limestone.'],
    ['Galveston Pleasure Pier', 'Galveston', 'Beach', 29.2880, -94.7820, 'A vintage amusement pier over the Gulf.'],
    ['Lost Maples', 'Vanderpool', 'Nature', 29.8200, -99.5700, 'Rare bigtooth maples ablaze in autumn.'],
  ],
  UT: [
    ['Bryce Wall Street', 'Bryce', 'Canyon', 37.6270, -112.1650, 'A slot between towering hoodoo walls.'],
    ['Sand Hollow', 'Hurricane', 'Lake', 37.1200, -113.3800, 'Red-rock islands in a turquoise reservoir.'],
    ['Provo Bridal Veil Falls', 'Provo', 'Waterfall', 40.3340, -111.6010, 'A 600-foot double cataract in Provo Canyon.'],
    ['Cedar Breaks', 'Brian Head', 'Canyon', 37.6300, -112.8450, 'A high-elevation amphitheater of red hoodoos.'],
    ['Antelope Island', 'Syracuse', 'Lake', 41.0300, -112.2200, 'A bison-roamed island in the Great Salt Lake.'],
  ],
  VT: [
    ['Quechee Covered Bridge', 'Quechee', 'Bridge', 43.6500, -72.4100, 'A covered bridge over the falls in a mill village.'],
    ['Stowe Trapp Meadow', 'Stowe', 'Mountains', 44.5100, -72.7500, 'Alpine-style lodge meadows below the Green Mountains.'],
    ['Emerald Lake', 'East Dorset', 'Lake', 43.2400, -73.0100, 'A small green lake ringed by marble hills.'],
    ['Montpelier Capitol', 'Montpelier', 'Architecture', 44.2620, -72.5800, 'A gold-domed Greek Revival statehouse.'],
    ['Mount Philo', 'Charlotte', 'Mountains', 44.2800, -73.2200, 'A small summit over Lake Champlain farmland.'],
  ],
  VA: [
    ['Great Falls Mather Gorge', 'McLean', 'Canyon', 38.9950, -77.2480, 'A narrow gorge below the Potomac falls.'],
    ['Cape Henry Light', 'Virginia Beach', 'Lighthouse', 36.9270, -76.0070, 'Twin lighthouses where the bay meets the ocean.'],
    ['Humpback Rocks', 'Lyndhurst', 'Mountains', 37.9600, -78.8900, 'A rocky outcrop with Blue Ridge Parkway views.'],
    ['Shenandoah Old Rag', 'Etlan', 'Mountains', 38.5510, -78.3170, 'A famous granite-scramble summit.'],
    ['Assateague Chincoteague Marsh', 'Chincoteague', 'Nature', 37.9100, -75.3800, 'Salt marsh full of ponies and waterbirds.'],
  ],
  WA: [
    ['Seattle Pike Place', 'Seattle', 'Skyline', 47.6097, -122.3420, 'The historic public market and waterfront.'],
    ['Mount Rainier Paradise', 'Ashford', 'Mountains', 46.7860, -121.7360, 'Wildflower meadows below the glaciated summit.'],
    ['Olympic Rialto Beach', 'Forks', 'Beach', 47.9200, -124.6400, 'Sea stacks and a hole-in-the-wall arch.'],
    ['Leavenworth', 'Leavenworth', 'Architecture', 47.5960, -120.6620, 'A Bavarian-themed village in the Cascades.'],
    ['Gig Harbor', 'Gig Harbor', 'Skyline', 47.3290, -122.5800, 'A boat-filled harbor with Mount Rainier beyond.'],
  ],
  WV: [
    ['Blackwater Lindy Point', 'Davis', 'Canyon', 39.1000, -79.4800, 'A clifftop overlook of the Blackwater Canyon.'],
    ['Beartown State Park', 'Hillsboro', 'Nature', 38.0700, -80.2700, 'A boardwalk through eroded sandstone "rooms".'],
    ['Babcock Glade Creek Mill', 'Clifftop', 'Historic', 38.0300, -80.9500, 'The most-photographed mill in West Virginia.'],
    ['Cass Scenic Railroad', 'Cass', 'Historic', 38.3970, -79.9110, 'A steam logging railway up Bald Knob.'],
    ['Smoke Hole Canyon', 'Petersburg', 'Canyon', 38.8400, -79.2400, 'A rugged river canyon with rock fins.'],
  ],
  WI: [
    ['Door County Cave Point Arches', 'Sturgeon Bay', 'Beach', 44.9200, -87.2700, 'Wave-carved limestone arches and caves.'],
    ['Wisconsin Capitol', 'Madison', 'Architecture', 43.0750, -89.3840, 'A granite dome between two lakes.'],
    ['Copper Falls', 'Mellen', 'Waterfall', 46.3700, -90.6400, 'Tannin-stained waterfalls in a deep gorge.'],
    ['Wyalusing Bluffs', 'Bagley', 'Nature', 42.9800, -91.1200, 'Bluffs above the Wisconsin-Mississippi confluence.'],
    ['Apostle Islands Lighthouse', 'Bayfield', 'Lighthouse', 46.9700, -90.6700, 'Historic island lighthouses on Lake Superior.'],
  ],
  WY: [
    ['Tetons Mormon Row Moulton', 'Moose', 'Historic', 43.7340, -110.6630, 'The pink Moulton barn beneath the peaks.'],
    ['Yellowstone Norris Basin', 'Yellowstone', 'Nature', 44.7260, -110.7030, 'The hottest, most dynamic geyser basin.'],
    ['Tetons String Lake', 'Moose', 'Lake', 43.7900, -110.7300, 'A shallow turquoise lake between bigger lakes.'],
    ['Flaming Gorge', 'Green River', 'Canyon', 41.2200, -109.4600, 'Red canyon walls above a deep blue reservoir.'],
    ['Medicine Wheel', 'Lovell', 'Historic', 44.8270, -107.9220, 'An ancient stone circle high in the Bighorns.'],
  ],
}
